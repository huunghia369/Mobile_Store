...
public class Khach_hang extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        PopupMenuMAKH = new javax.swing.JPopupMenu();
        MenuItemMAKH = new javax.swing.JMenuItem();
        ...
        MenuItemMAKH.setText("Mã KH gồm 10 ký tự\n  VD: KH12345678, Mb3Dvcxd8a, ...");
        PopupMenuMAKH.add(MenuItemMAKH);
        ...
        BtnKhoiPhucKH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8-restart-48.png"))); // NOI18N
        ...
        BtnXoaVinhVien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8-remove-48.png"))); // NOI18N
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(LabelXoaVinhVien, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addComponent(LabelKhoiPhuc, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(165, 165, 165))
            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel4Layout.createSequentialGroup()
    ...
    private void TxtMaKHKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TxtMaKHKeyTyped
        // TODO add your handling code here:
        PopupMenuMAKH.show(this, 56, 500);
        if (TxtMaKH.getText().length() == 9){
            TxtMaKH.setBackground(Color.white);
        }
        if (TxtMaKH.getText().length() >= 10) {
            TxtMaKH.setBackground(Color.white);
            String makh = TxtMaKH.getText().trim();
            String dinhdangMaKH = "^\\w{10}$";
            if (!makh.matches(dinhdangMaKH)) {                
