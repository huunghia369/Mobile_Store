...
//        }else if ((tungay.compareTo(date) <= 0) && (denngay.compareTo(date) >= 0) && (((c2.getTime().getTime() - c1.getTime().getTime())/(24*3600*1000))  <= 30) && (((c2.getTime().getTime() - c3.getTime().getTime())/(24*3600*1000)) <= 30) || (tungay.compareTo(denngay) == 0)){
    ...
    private void initComponents() {
        ...
        PopupMenuMAGG = new javax.swing.JPopupMenu();
        MenuItemMAGG = new javax.swing.JMenuItem();
        ...
        MenuItemMAGG.setText("Mã GG gồm 10 ký tự  \n  VD: GG32fs2sxavv, Ms3x88svsa, ...");
        PopupMenuMAGG.add(MenuItemMAGG);
        ...
        if (TbTatCa.getColumnModel().getColumnCount() > 0) {
            TbTatCa.getColumnModel().getColumn(1).setMinWidth(100);
        ...
        if (TbDangDienRa.getColumnModel().getColumnCount() > 0) {
            TbDangDienRa.getColumnModel().getColumn(1).setMinWidth(100);
        ...
        if (TbSapDienRa.getColumnModel().getColumnCount() > 0) {
            TbSapDienRa.getColumnModel().getColumn(1).setMinWidth(100);
        ...
        if (TbDaKetThuc.getColumnModel().getColumnCount() > 0) {
            TbDaKetThuc.getColumnModel().getColumn(1).setMinWidth(100);
        ...
        LabelThongBaoGGTS.setOpaque(true);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(TxtSPDuocAD, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE))))
            .addGroup(layout.createSequentialGroup()
                .addGap(6, 6, 6)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(PanelGiamGiaTheoTungSP, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(PanelGiamGiaTheoKH, javax.swing.GroupLayout.DEFAULT_SIZE, 394, Short.MAX_VALUE)
                                        .addComponent(LabelThongBaoGGTS, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(LabelSPDuocAP)
                                        .addComponent(TxtSPDuocAD, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(BtnThem)
    ...
    private void TxtMaGGKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TxtMaGGKeyTyped
        // TODO add your handling code here:
        PopupMenuMAGG.show(this, 885, 47);
        if (TxtMaGG.getText().length() == 9) {
            TxtMaGG.setBackground(Color.white);
        }
        if (TxtMaGG.getText().length() >= 10) {
            TxtMaGG.setBackground(Color.white);
            String makh = TxtMaGG.getText().trim();
    ...
    }//GEN-LAST:event_TxtMaGGKeyTyped
    ...
    private javax.swing.JMenuItem MenuItemMAGG;
    ...
    private javax.swing.JPopupMenu PopupMenuMAGG;
